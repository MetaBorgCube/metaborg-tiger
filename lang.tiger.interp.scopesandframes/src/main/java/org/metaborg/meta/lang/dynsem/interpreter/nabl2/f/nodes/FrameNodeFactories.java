...
public final class FrameNodeFactories {
	...
	public static InitProtoFrame createInitProtoFrame(TruffleLanguage<? extends IWithScopesAndFramesContext> lang) {
		return InitProtoFrameNodeGen.create(lang);
	}
	...
	public static DefaultValue createDefaultValue(TruffleLanguage<? extends IWithScopesAndFramesContext> language) {
		return DefaultValueNodeGen.create(language);
	}
