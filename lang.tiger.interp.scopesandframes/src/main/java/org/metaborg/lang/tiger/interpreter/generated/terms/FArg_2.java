...
public final class FArg_2 extends FArg {
	...
	public FArg_2(Occ _1, Ty _2) {
		this(_1, _2, null);
	}

	private FArg_2(Occ _1, Ty _2, IStrategoTerm strategoTerm) {
		this._1 = _1;
		this._2 = _2;
	...
	public static FArg_2 create(IStrategoTerm term) {
		...
		return new FArg_2(Occ.create(term.getSubterm(0)), Ty.create(term.getSubterm(1)), term);
	}
