...
public final class IfThen_2 extends Exp {
	...
	public IfThen_2(Exp _1, Exp _2) {
		this(_1, _2, null);
	}

	private IfThen_2(Exp _1, Exp _2, IStrategoTerm strategoTerm) {
		this._1 = _1;
		this._2 = _2;
	...
	public static IfThen_2 create(IStrategoTerm term) {
		...
		return new IfThen_2(Exp.create(term.getSubterm(0)), Exp.create(term.getSubterm(1)), term);
	}
