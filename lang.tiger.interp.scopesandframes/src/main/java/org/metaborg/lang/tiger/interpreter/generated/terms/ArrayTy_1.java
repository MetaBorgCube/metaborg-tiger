...
public final class ArrayTy_1 extends Ty {
	public final static String CONSTRUCTOR = "ArrayTy";

	public final static int ARITY = 1;

	public ArrayTy_1(TypeId _1) {
		this(_1, null);
	}

	private ArrayTy_1(TypeId _1, IStrategoTerm strategoTerm) {
		this._1 = _1;
	...
	public static ArrayTy_1 create(IStrategoTerm term) {
		...
		return new ArrayTy_1(TypeId.create(term.getSubterm(0)), term);
	}
