...
public final class Field_2 extends Field {
	...
	public Field_2(Occ _1, TypeId _2) {
		this(_1, _2, null);
	}

	private Field_2(Occ _1, TypeId _2, IStrategoTerm strategoTerm) {
		this._1 = _1;
		this._2 = _2;
	...
	public static Field_2 create(IStrategoTerm term) {
		...
		return new Field_2(Occ.create(term.getSubterm(0)), TypeId.create(term.getSubterm(1)), term);
	}
