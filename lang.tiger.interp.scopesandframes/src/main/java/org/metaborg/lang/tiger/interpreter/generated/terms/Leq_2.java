...
public final class Leq_2 extends Exp {
	...
	private Leq_2(Exp _1, Exp _2, IStrategoTerm strategoTerm) {
		this._1 = _1;
		this._2 = _2;
	...
	public static Leq_2 create(IStrategoTerm term) {
		...
		return new Leq_2(Exp.create(term.getSubterm(0)), Exp.create(term.getSubterm(1)), term);
	}
