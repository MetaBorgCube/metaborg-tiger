...
public final class __Id2Occ___1 extends Occ {
	...
	private __Id2Occ___1(String _1, IStrategoTerm strategoTerm) {
		this._1 = _1;
	...
	public static __Id2Occ___1 create(IStrategoTerm term) {
		...
		return new __Id2Occ___1(Tools.asJavaString(term.getSubterm(0)), term);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		__Id2Occ___1 other = (__Id2Occ___1) obj;
		if (_1 == null) {
			if (other._1 != null) {
				return false;
			}
