...
public final class Plus_2 extends Exp {
	...
	public Object evaluate(TigerHeap h, TigerEnv e) {
		IntV v1 = (IntV) _1.evaluate(h, e);
		IntV v2 = (IntV) _2.evaluate(h, e);
		return new IntV(v1.value() + v2.value());
	}

	private Plus_2(Exp _1, Exp _2) {
		this._1 = _1;
		this._2 = _2;
	}
	...
	public static Plus_2 create(IStrategoTerm term) {
		...
		return new Plus_2(Exp.create(term.getSubterm(0)), Exp.create(term.getSubterm(1)));
	}
}