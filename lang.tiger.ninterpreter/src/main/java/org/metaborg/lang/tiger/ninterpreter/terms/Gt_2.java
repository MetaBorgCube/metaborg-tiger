...
public final class Gt_2 extends Exp {
	...
	public Object evaluate(TigerHeap heap, TigerEnv env) {
		IntV lte = (IntV) new Leq_2(_1, _2).evaluate(heap, env);

		return lte.value() == 1 ? new IntV(0) : new IntV(1);
	}

	private Gt_2(Exp _1, Exp _2) {
		this._1 = _1;
		this._2 = _2;
	}
	...
	public static Gt_2 create(IStrategoTerm term) {
		...
		return new Gt_2(Exp.create(term.getSubterm(0)), Exp.create(term.getSubterm(1)));
	}
}